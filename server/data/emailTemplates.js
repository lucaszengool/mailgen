...
IMPORTANT: Write ONLY the email content. Do not include any subject line, headers, or metadata.
...
- ALWAYS start each paragraph with exactly two spaces (  ) for proper indentation
- Add blank lines between each paragraph for clean readability
- Write in plain text only - no special formatting
- Each paragraph should naturally lead to the next
- Example format:
  First paragraph with two space indentation.

  Second paragraph with two space indentation and blank line above.
- Professional yet conversational tone
- Be concise but compelling
- Focus on mutual value and benefits

ABSOLUTELY DO NOT include:
- Any placeholders in brackets like [Date/Time], [Location], [Your Name], [Contact Information], [Your Email]
- Any placeholder text like "Your Name" or "Your Title" - use actual names from the context
- Markdown symbols (no **, no ---, no ###, no *, no _, no backticks)
- Section headers like "**Next Steps:**", "**Value Proposition:**", "**Partnership Benefits:**"
- Bold text formatting (no ** around text)
- Bullet point symbols (no * or -)
- Subject lines in the email body (no "Subject:" text)
- Multiple greetings or duplicate content
- Any brackets [] {} or angle brackets <>
- Generic phrases that need filling in
- Numbered lists like "1. **Item:**" or "2. **Item:**"
- Any formatting that looks like markdown
- If you don't have specific data, write around it naturally without placeholders

CRITICAL: Write in flowing paragraph format with natural transitions. Do not use any formatting symbols.
    ...
    html: `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background: white;">
        ...
        <div id="component-logo" style="text-align: center; padding: 20px; background: white; border-bottom: 2px solid #e9ecef;">
          <img src="https://via.placeholder.com/120x40/28a745/ffffff?text=COMPANY+LOGO" alt="Company Logo" style="max-width: 120px; height: auto; display: block; margin: 0 auto; object-fit: contain;">
    ...
    html: `
      <div style="font-family: 'Georgia', serif; max-width: 650px; margin: 0 auto; background: white; border: 1px solid #e5e5e5;">
        ...
        <div style="padding: 45px 40px;">
          ...
          <div id="component-stats-showcase" style="background: #f8f9fa; padding: 30px; margin: 35px 0; border-left: 4px solid #28a745;">
...
Write the complete email now (without subject line or email headers):`,
    ...
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: white;">
        ...
        <div id="component-product-hero" style="background: #f8f9fa; padding: 50px 30px; text-align: center; color: #343a40;">
...
Write the complete email now (without subject line or email headers):`,
    ...
    html: `
      <div style="font-family: 'Times New Roman', serif; max-width: 620px; margin: 0 auto; background: white; border: 2px solid #e8e8e8;">
        ...
        <div id="component-expert-header" style="background: white; padding: 35px 40px; border-bottom: 1px solid #dee2e6;">
          <div style="display: flex; align-items: center; gap: 20px;">
            ...
            <div>
              ...
              <div style="margin-top: 8px;">
                <span style="background: #f8f9fa; padding: 4px 12px; border-radius: 20px; font-size: 12px; color: #343a40; text-transform: uppercase; letter-spacing: 1px;">Industry Expert</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style="padding: 40px;">
          ...
          <div id="component-case-study" style="border-left: 4px solid #28a745; background: #f8f9fa; padding: 25px; margin: 35px 0;">
      ...
      <div style="font-family: 'Nunito', -apple-system, sans-serif; max-width: 600px; margin: 0 auto; background: white;">
        ...
        <div id="component-event-hero" style="background: #343a40; color: white; padding: 40px 30px; text-align: center; position: relative;">
          <div style="position: relative; z-index: 2;">
            ...
            <div style="background: #f8f9fa; color: #343a40; padding: 15px; border-radius: 8px; display: inline-block;">
        ...
        <div style="padding: 40px 30px;">
          ...
          <div id="component-agenda-timeline" style="background: #f8f9fa; padding: 30px; border-radius: 12px; margin: 35px 0;">
          ...
          <div id="component-speaker-showcase" style="background: #f8f9fa; padding: 30px; border-radius: 12px; margin: 35px 0; border: 1px solid #e9ecef;">
          ...
          <div id="component-registration-cta" style="background: #28a745; color: white; padding: 35px; text-align: center; border-radius: 15px; margin: 35px 0; position: relative;">
            ...
            <a href="https://register.event.com"
               style="display: inline-block; background: white; color: #28a745; padding: 16px 35px; text-decoration: none; border-radius: 50px; font-weight: 700; font-size: 17px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
              Register Free Now
            </a>
