    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <Loader className="w-12 h-12 animate-spin mx-auto mb-4" style={{ color: '#00f5a0' }} />
          <h2 className="text-2xl font-bold text-black mb-2">Analyzing Website</h2>
          <p className="text-gray-500">Our AI is analyzing {targetWebsite}...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="max-w-md mx-auto text-center">
          ...
          <h2 className="text-2xl font-bold text-black mb-2">Analysis Failed</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <label className="px-4 py-2 border-2 border-gray-300 text-gray-700 rounded-xl text-sm font-semibold hover:border-gray-400 cursor-pointer transition-all">
                Upload
                <input
                  type="file"
              ...
              <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="flex-1 text-gray-900 text-sm leading-relaxed border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#00f5a0] focus:border-[#00f5a0] resize-none font-medium transition-all bg-white"
                  />
                  <button
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-3">
                      ...
                      <input
                        ...
                        className="flex-1 font-semibold text-gray-900 text-sm border border-gray-200 rounded-xl px-4 py-2 focus:ring-2 focus:ring-[#00f5a0] focus:border-[#00f5a0] transition-all bg-white"
                      />
                    </div>
                    <textarea
                      ...
                      className="w-full text-gray-700 text-sm leading-relaxed border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#00f5a0] focus:border-[#00f5a0] resize-none font-medium transition-all bg-white"
                    />
                  </div>
                  <button
            ...
            <div className="grid grid-cols-2 gap-6">
              {analysis.contactInfo.email && (
                <div>
                  ...
                  <div className="font-semibold text-black">{analysis.contactInfo.email}</div>
                </div>
              )}
              {analysis.contactInfo.phone && (
                <div>
                  <div className="text-sm text-gray-500 mb-2 font-medium">Phone</div>
                  <div className="font-semibold text-black">{analysis.contactInfo.phone}</div>
                </div>
              )}
            </div>
          </div>
