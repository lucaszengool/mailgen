...
const TemplateSelectionModal = ({ isOpen, onClose, onSelectTemplate, onConfirm, isSubmitting = false, templateRequest = null }) => {
  ...
  const handleCustomize = (templateId, event) => {
    ...
    setCustomTemplateData({
      ...
      customizations: {
        ...
        primaryColor: '#000000', // green-500
        accentColor: '#6b7280', // green-700
  ...
  const getDefaultPropertiesForComponent = (type) => {
    switch (type) {
      ...
      case 'cta':
        return { text: 'Get Started', url: 'https://your-website.com', color: '#000000' };
      case 'testimonial':
      ...
      case 'banner':
        return { title: 'Welcome!', subtitle: 'Discover our amazing products', color: '#000000' };
      default:
        return {};
    }
  };
